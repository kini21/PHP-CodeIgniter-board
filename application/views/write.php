...
<div id="main">
    ...
    <form id="contents_form" method="post" action="/Board/write">
        ...
        <table id="contents_write">
            <tr>
                ...
                <td width="300px" class="tl" style="padding-left: 0;"><input id="w_author" type="text" name="author" value="<?php echo set_value('author'); ?>"></td>
                <td width="100px"><label for="w_password">비밀번호</label></td>
                <td width="300px" class="tl" style="padding-left: 0;"><input id="w_password" type="password" name="password" value="<?php echo set_value('password'); ?>"></td>
            </tr>
            <tr>
                <td><label for="w_email">이메일</label></td>
                <td class="tl" style="padding-left: 0;"><input id="w_email" type="text" name="email" value="<?php echo set_value('email'); ?>"></td>
                <td><label for="w_tel">전화번호</label></td>
                <td class="tl" style="padding-left: 0;"><input id="w_tel" type="text" name="tel" value="<?php echo set_value('tel'); ?>"></td>
            </tr>
            <tr>
                <td><label for="w_title">제목</label></td>
                <td class="tl" style="padding-left: 0;"><input id="w_title" type="text" name="title" value="<?php echo set_value('title'); ?>"></td>
                <td><label for="w_secret">비밀글</label></td>
                <input type="hidden" name="secret" value="" />
                <td class="tl"><input id="w_secret" type="checkbox" name="secretCheck" value="" style="width: auto;"></td>
            </tr>
            <tr class="tl" style="padding-left: 0;">
                <td colspan="4" style="border-bottom: none;"><textarea id="w_description" name="description"><?php echo set_value('description'); ?></textarea></td>
            </tr>
            <tr>
                ...
                <td colspan="2" class="tr" style="border-bottom: none;">
                    <span class="ebtn "onclick="write_submit();">등록</span>
                </td>
            </tr>
        </table>
    </form>

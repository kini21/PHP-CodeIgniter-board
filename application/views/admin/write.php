...
<form id="contents_form" action="/Admin_board/write" method="post">
    ...
    <table class="write_table" style="margin-top: 10px;">
        <tr>
            ...
            <td><input type="text" value="<?php echo set_value('title'); ?>" placeholder="이름을 입력해주세요" name="author" class="write_input"></td>
        </tr>
        <tr>
            <td>이메일</td>
            <td><input type="text" value="<?php echo set_value('email'); ?>" placeholder="이메일을 입력해주세요" name="email" class="write_input"></td>
        </tr>
        <tr>
            <td>전화번호</td>
            <td><input type="text" value="<?php echo set_value('tel'); ?>" placeholder="전화번호를 입력해주세요" name="tel" class="write_input"></td>
        </tr>
        <tr>
            <td>비밀번호</td>
            <td><input type="password" value="<?php echo set_value('password'); ?>" placeholder="비밀번호를 입력해주세요" name="password" class="write_input"></td>
        </tr>
        <tr>
            <td>비밀글</td>
            <input type="hidden" name="secret" value="" />
            <td><input type="checkbox" value="" name="secretCheck"></td>
        </tr>
        <tr>
            <td>제목</td>
            <td><input type="text" value="" placeholder="제목을 입력해주세요" name="title" class="write_input"></td>
        </tr>
        <tr>
